...
if ( !function_exists( 'cs_articlemag_shortcode_block' ) && function_exists( 'register_block_type' ) ) {
	...
	function cs_articlemag_shortcode_block() {
		...
		wp_register_script(
		'articlemag-shortcode-block', FRAMEWORK_ASSETS . '/js/cs-gutenberg-block.js', array( 'wp-blocks', 'wp-editor', 'wp-element', 'wp-components' )
		);

		register_block_type( 'articlemag/shortcode-block', array(
	...
	<table class="form-table">
		<tr>
			...
			<td>
				...
				<span class="description"><?php _e( "Please enter your url." ); ?></span>
			</td>
		</tr>
