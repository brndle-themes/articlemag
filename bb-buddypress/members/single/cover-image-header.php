 ...
 *
 * This template can be overridden by copying it to yourtheme/bb-buddypress/members/single/cover-image-header.php.
 *
...
<div id="cover-image-container" class="<?php echo esc_attr( $social_networks_urls_div_class ); ?>">
	<div id="header-cover-image" class="<?php echo esc_attr( $has_cover_image_position . $has_cover_image ); ?>">
		...
		if ( $bp_is_my_profile ) {
			?>
			<a href="<?php echo esc_url( bp_get_members_component_link( 'profile', 'change-cover-image' ) ); ?>" class="link-change-cover-image bp-tooltip" data-bp-tooltip-pos="right" data-bp-tooltip="<?php esc_attr_e( 'Change Cover Photo', 'articlemag' ); ?>">
			...
			if ( ! empty( $cover_image_url ) && bp_attachments_get_user_has_cover_image( $bp_displayed_user_id ) ) {
				...
				<div class="header-cover-reposition-wrap">
					...
					<img src="<?php echo esc_url( $cover_image_url ); ?>" alt="<?php esc_attr_e( 'Cover photo', 'articlemag' ); ?>"/>
				</div>
				<?php
			}
		}
		...
		<div id="item-header-cover-image" class="item-header-wrap <?php echo esc_attr( bp_disable_cover_image_uploads() ? 'bb-disable-cover-img' : 'bb-enable-cover-img' ); ?>">
			...
			<div id="item-header-avatar" class="<?php echo esc_attr( $moderation_class ); ?>">
				...
				if ( $bp_is_my_profile && ! bp_disable_avatar_uploads() ) {
					?>
					<a href="<?php bp_members_component_link( 'profile', 'change-avatar' ); ?>" class="link-change-profile-image bp-tooltip" data-bp-tooltip-pos="down" data-bp-tooltip="<?php esc_attr_e( 'Change Profile Photo', 'articlemag' ); ?>">
			...
			<div class="modal-wrapper">
				<div class="modal-container">
					<header class="bb-model-header">
						<h4><span class="target_name"><?php echo esc_html__( 'Remove Connection', 'articlemag' ); ?></span></h4>
					...
					<div class="bb-remove-connection-content bb-action-popup-content">
						<p>
							...
							echo sprintf(
								...
								esc_html__( 'Are you sure you want to remove %s from your connections?', 'articlemag' ),
					...
					<footer class="bb-model-footer flex align-items-center">
						<a class="bb-close-remove-connection bb-close-action-popup" href="#"><?php echo esc_html__( 'Cancel', 'articlemag' ); ?></a>
						<a class="button push-right bb-confirm-remove-connection" href="#"><?php echo esc_html__( 'Confirm', 'articlemag' ); ?></a>
					</footer>
				</div>
			</div>
		</div>
