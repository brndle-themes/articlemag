 ...
 *
 * This template can be overridden by copying it to yourtheme/bb-buddypress/members/single/friends/requests.php.
 *
...
<h2 class="screen-heading friendship-requests-screen"><?php esc_html_e( 'Requests to Connect', 'articlemag' ); ?></h2>
