 ...
 *
 * This template can be overridden by copying it to yourtheme/bb-buddypress/groups/single/cover-image-header.php.
 *
			...
			<div class="modal-wrapper">
				<div class="modal-container">
					<header class="bb-model-header">
						<h4><span class="target_name"><?php echo esc_html__( 'Group Description', 'articlemag' ); ?></span></h4>
