...
if ( is_front_page() && ! is_woocommerce_shop() && empty( $cs_post_meta['header_transparent'] ) && empty( $cs_post_meta['force_show_header'] ) ) {
	return; }

// check page header-active.
if ( ! empty( $cs_post_meta['disable_header'] ) && empty( $cs_post_meta['force_show_header'] ) ) {
	return; }
