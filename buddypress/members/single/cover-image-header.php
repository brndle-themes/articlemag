		...
		<div id="item-header-cover-image">
			<div id="item-header-avatar">
				<?php if ( bp_is_my_profile() && ! bp_disable_avatar_uploads() ) { ?>
					<a href="<?php bp_members_component_link( 'profile', 'change-avatar' ); ?>" class="link-change-profile-image bp-tooltip" data-bp-tooltip-pos="up" data-bp-tooltip="<?php esc_attr_e( 'Change Profile Photo', 'articlemag' ); ?>">
						<?php
						if ( function_exists( 'buddypress' ) && isset( buddypress()->buddyboss ) ) {
							?>
								<i class="bb-icon-bf bb-icon-camera"></i>
			...
			<div id="item-header-content">
				...
				if ( function_exists( 'bp_member_type_list' ) ) :
					bp_member_type_list(
						...
						array(
							'label'        => array(
								'plural'   => __( 'Member Types', 'articlemag' ),
								'singular' => __( 'Member Type', 'articlemag' ),
							),
							'list_element' => 'span',
						)
					);
