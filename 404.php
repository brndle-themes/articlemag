      ...
      <div class="col-md-12">
        <article id="post-404" class="post-not-found cs-error-404">
          <div class="entry-content text-center">
            ...
            <h1 class="cs-404"><?php _e( '404', 'articlemag'); ?></h1>
            <h2 class="cs-not-found"><?php _e( 'Not Found!', 'articlemag'); ?></h2>

            <hr />

            <p><?php _e( 'It looks like nothing was found at this location. Maybe try a search?', 'articlemag' ); ?></p>
