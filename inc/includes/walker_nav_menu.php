	...
	class Walker_Nav_Menu_Custom extends Walker_Nav_Menu {
		...
		public function custom_wrap() {
			...
			if ( ! is_user_logged_in() ) {
				...
				$output .= '<a href="' . wp_login_url() . '" class="cs-btn cs-btn-flat cs-btn-rounded cs-btn-md cs-btn-flat-accent signin-button"> ' . esc_attr( 'Sign in', 'articlemag' ) . '</a>';
				$output .= '</div>';
				$output .= '</li>';
			}
			...
			if ( ! is_user_logged_in() ) {
				if ( get_option( 'users_can_register' ) ) {
					$output .= '<li class="cs-depth-0 cs-user-signin">';
					$output .= '<div class="cs-link cs-sticky-item">';
					$output .= '<a href="' . wp_registration_url() . '" class="cs-btn cs-btn-flat cs-btn-rounded cs-btn-md cs-btn-flat-accent signup-button"> ' . esc_attr( 'Sign up', 'articlemag' ) . '</a>';
					$output .= '</div>';
					$output .= '</li>';
				}
			}
