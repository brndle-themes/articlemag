...
if ( ! function_exists( 'articlemag_option_sections' ) ) {
	function articlemag_option_sections() {
		$sections = array();
		// top bar
		// -----------------------------------------------------------------------------------------
		...
		$sections['top_bar'] = array(
			...
			'fields' => array(
				...
				array(
					...
					'desc'                   => 'Top bar left block. Just add a module. Also you can drag drop position',
					'type'                   => 'group',
					'button_title'           => 'Add New Module',
					'accordion_title_prefix' => 'Module:',
				...
				array(
					...
					'desc'                   => 'Top bar right block. Just add a module. Also you can drag drop position',
					'type'                   => 'group',
					'fields'                 => $top_bar_fields,
					'button_title'           => 'Add New Module',
					'accordion_title_prefix' => 'Module:',
		...
		$sections['header'] = array(
			...
			'fields' => array(
				...
				array(
					...
					'title'   => 'Header Style',
					'options' => array(
						'default' => FRAMEWORK_URI . '/config/widgets/nav-model1.png',
						'left'    => FRAMEWORK_URI . '/config/widgets/nav-model2.png',
						'center'  => FRAMEWORK_URI . '/config/widgets/nav-model3.png',
						'fancy'   => FRAMEWORK_URI . '/config/widgets/nav-model4.png',
					),
					'default' => 'default',
				),
			),
		...
		$footer_socail_fields = array(
			...
			array(
				...
				'type'       => 'icon',
				'title'      => 'Icon',
				'dependency' => array( 'module', 'any', 'social' ),
			),
			array(
				'id'         => 'link',
				'type'       => 'text',
		...
		<div class="pull-right">Build with [cs_fa icon="heart" style="color: red"] WordPress</div>',
				...
				array(
					'id'                     => 'footer_social',
					'title'                  => 'Footer Social',
					'desc'                   => 'Footer icons block. Just add a shortcode [cs_social] <br /> so easy.',
					'type'                   => 'group',
					'fields'                 => $footer_socail_fields,
					'button_title'           => 'Add New Module',
					'accordion_title_prefix' => 'Module:',
					'default'                => array(
						array(
		...
		$sections['extras'] = array(
			...
			'fields' => array(
				...
				array(
					...
					'default'    => 'Select a page for Maintance Mode',
		...
		require THEME_DIR . '/edd-updater/theme-updater-admin.php';
		...
		$updater = new EDD_Articlemag_Theme_Updater_Admin(
			...
			// Strings
			$strings = array(
				'theme-license'             => __( 'Articlemag - License', 'articlemag' ),
				'enter-key'                 => __( 'Enter your license key.', 'articlemag' ),
		...
		$message     = $updater->license_page();

		// License Options
		// -----------------------------------------------------------------------------------------
		$sections['license'] = array(
			'title'  => esc_html__( 'License', 'articlemag' ),
			'desc'   => esc_html__( 'Articlemag Theme License!', 'articlemag' ),
			'fields' => array(
				array(
					'id'    => 'articlemag_license',
					'type'  => 'text',
					'title' => esc_html__( 'License', 'articlemag' ),
					'desc'  => $message,
				),
