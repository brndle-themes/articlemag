...
function articlemag_import_files() {
	return array(
		array(
			'import_file_name'             => 'articlemag Default',
			'import_file_url'              => get_template_directory_uri() . '/inc/merlin/demos/articlemag/demo-content.xml',
			'import_widget_file_url'       => get_template_directory_uri() . '/inc/merlin/demos/articlemag/widgets.json',
			'import_customizer_file_url'   => get_template_directory_uri() . '/inc/merlin/demos/articlemag/customizer.dat',
			'import_cs_framework_file_url' => get_template_directory_uri() . '/inc/merlin/demos/articlemag/theme-option.txt',
			'import_redux'                 => array(),
